...
const MidPageLogo = () => {
  return(
   <div>
     <Image className="w-[100%] mt-16 mb-16 md:w-dvw md:mr-[2rem] lg:w-dvw" src={standAloneLogo} width={100} height={100} alt="mockup image"/>
   </div>
  )
 }
  ...
  return(
   <div className="bg-black pb-8 pt-12 text-white text-[20px] overflow-hidden lg:pr-[1rem]">
      ...
      <div className="md:pl-[2rem]">
        ...
        <span className={`text-amber-100 flex justify-center pt-4 text-2xl md:text-2xl ${brunoAce.className}`}>TANTALIZER - 2023</span>
        ...
        <section className={`md:flex md:gap-10 md:text-[15px] md:mt-8 md:pl-[0rem] md:pr-[3rem] lg:pl-[10rem] lg:pr-[10rem] ${poppins.className}`}>
        ...
        <section className="mt-8 bg-[#1B1B1B] pl-10 pt-8 pr-10 pb-10 lg:pl-[8rem] lg:pr-[10rem]">
          <div> 
            <h2 className={`text-4xl pb-6 font-bold ${figtree.className}`}>THE PROBLEM</h2>
          ...
          <div className="mt-14">
            <h2 className={`text-4xl pb-6 font-bold ${figtree.className}`}>THE SOLUTION</h2>
              <p className={`${poppins.className}`}>In response to the challenges of increased competition, a need for modernisation, and the imperative to adopt a robust digital strategy, the core solution proposed is a comprehensive redesign of Tantalizers&#39; website. This redesign aims to transform the online customer experience, making it seamless and intuitive for users to explore the menu, place orders, and engage with the brand
              </p>
          </div>
        </section>
          <MidPageLogo />
        <div className={`pl-8 pr-8 lg:pl-[8rem] lg:pr-[10rem] ${poppins.className}`}>
            <h1 className={`text-5xl leading-12 font-bold ${figtree.className}`}>THE WEBSITE UX AUDIT AND RESEARCH PROCESS</h1>
        ...
        <section className={`bg-[#1B1B1B] mt-8 pt-6 pl-6 pr-6 pb-8 md:pt-10 lg:pl-[4rem] lg:pr-[1rem] lg:flex lg:gap-[2.5rem] ${poppins.className}`}>
            <div className="flex flex-col gap-4 lg:flex">
              <h2 className={`text-[27px] md:text-4xl lg:text-2xl ${figtree.className}`}>Website Visitor&#39;s Painpoint</h2>
              <div className="rounded-2xl border p-4 mt-4">
        ...
        <section className="mt-12 pl-[2rem] pr-8 md:mt-10 lg:pl-[8rem] lg:pr-[8rem] lg:mt-[5rem]">
          <h1 className="text-4xl">CURATING A DELECTABLE DIGITAL EXPERIENCE  TO SATISFY CRAVINGS AND BUILD <br /> LOYALTY</h1>
        ...
        <section className={`p-5 bg-[#1B1B1B] mb-20 md:pl-[2.5rem] lg:p-[2rem] lg:pl-[5rem] lg:pr-[5rem] ${figtree.className}`}>
            <h3 className={`lg:text-4xl ${poppins.className}`}>TIME TO RETROSPECT!</h3>
...
// https://x06pch9n-3000.uks1.devtunnels.ms/