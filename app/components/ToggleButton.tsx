...
const ToggleMode = ({currentSection, setCurrentSection}: ToggleModeProps) => {
 ...
 return(
   <div>
       {largeScreen? (
         <div className="rounded-[2.5rem] ml-[10rem] flex bg-gray-800 gap-4 p-[0.9rem]font-figtree text-white">
         ...
         <div className="rounded-[2.5rem] flex bg-gray-800 gap-4 p-[0.5rem] font-figtree text-white">
